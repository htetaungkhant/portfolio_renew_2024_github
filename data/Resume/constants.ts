...
export const abilitiesDetails = {
    ...
    abilities: [
        ...
        "Myanmar (Burmese) is <strong>native</strong> language. <strong>Intermediate</strong> level in English and basic <strong>N4</strong> level in Japan.",
        ...
        "Experience on modern technologies related to React.js such as <strong>NextAuth, Clerk, Stripe, Storybook, zod, react-hook-form, Zustand, Tanstack, React Router, Supabase</strong> and <strong>Prisma</strong>.",
        ...
        "Experience on localization technologies such as <strong>i18n</strong>.",
